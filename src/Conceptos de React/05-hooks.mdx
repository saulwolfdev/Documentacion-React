...
# Hooks
 ...
 Algunos hooks comunes incluyen **useState**, **useEffect**, **useContext**, **useMemo**, *useReducer**.
...
Estos son solo algunos ejemplos de hooks en React. Hay otros hooks como **useCallback** entre otros que proporcionan funcionalidades adicionales para trabajar con componentes de función en React.