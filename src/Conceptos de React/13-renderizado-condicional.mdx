...
En este ejemplo, el componente **ConditionalRenderingExample** tiene un estado **isLoggedIn** que controlamos con el **Hook** [useState](/docs/conceptos-de-react-04-hooks--docs) 
