...
### Ejemplo de useMemo:
Supongamos que tenemos un componente que realiza un cálculo costoso y queremos memorizar el resultado para evitar recálculos innecesarios.
...
<CodeBlock
  ...
  `} 
  language='javascript'
  sandboxUrl="https://codesandbox.io/p/sandbox/usememo-w5nfmn"
  showButtons= {true}
/>
