...
Estos son algunos métodos que son nativos de JavaScript para utilizarlos en tu aplicación simplemente accede a las propiedades y métodos de los strings y arrays.